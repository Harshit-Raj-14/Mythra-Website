...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'Facebook',
      href: 'https://facebook.com/myhraglobal',
      icon: (
    ...
    {
      name: 'Instagram',
      href: 'https://instagram.com/myhraglobal',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/company/myhraglobal',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/myhraglobal',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'YouTube',
      href: 'https://youtube.com/@myhraglobal',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className={styles.companySection}>
            <Link href="/" className={styles.logo}>
              ...
              <div className={styles.logoContent}>
                <span className={styles.companyName}>Myhra Global</span>
            ...
            <div className={styles.contactInfo}>
              ...
              <div className={styles.contactItem}>
                ...
                <span>info@myhraglobal.com</span>
              </div>
              <div className={styles.contactItem}>
                <svg className={styles.contactIcon} width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className={styles.footerBottom}>
          <div className={styles.bottomContent}>
            <p className={styles.copyright}>
              © {currentYear} Myhra Global Technologies. All rights reserved.
            </p>
